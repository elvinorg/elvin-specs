...
which access the functionality of the service through a client library
...
implemented by a number of cooperating routers acting as a cluster to
provide a single Elvin service.  Finally, an Elvin service may be
tiered across the Internet with local routers importing and exporting
